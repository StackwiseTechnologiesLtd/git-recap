...
export function DocsSidebar() {
  ...
  return (
    <aside className={`flex-shrink-0 border-r border-line bg-bg-panel/30 hidden md:flex flex-col h-full overflow-y-auto overflow-x-hidden transition-all duration-300 relative ${isCollapsed ? 'w-16' : 'w-[260px]'}`}>
      ...
      <nav className={`flex-1 px-3 pb-6 flex flex-col gap-1 ${isCollapsed ? 'items-center mt-4' : ''}`}>
        ...
        <a href="#install" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Getting Started" : undefined}>
          <BookIcon className="h-4 w-4 shrink-0" />
          {!isCollapsed && <span>Getting Started</span>}
        </a>
        <a href="#usage" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Built-in Modules" : undefined}>
        ...
        <a href="#timeframe" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Timeframe" : undefined}>
          <SettingsIcon className="h-4 w-4 shrink-0" />
          {!isCollapsed && <span>Timeframe</span>}
        </a>
        <a href="#routing" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Routing" : undefined}>
          <SettingsIcon className="h-4 w-4 shrink-0" />
          {!isCollapsed && <span>Routing</span>}
        </a>
        <a href="#options" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Options" : undefined}>
          <SettingsIcon className="h-4 w-4 shrink-0" />
        ...
        <a href="#requirements" className={`flex items-center gap-2 px-2 py-1.5 text-sm rounded-md hover:bg-bg-elevated text-muted hover:text-fg transition-colors whitespace-nowrap ${isCollapsed ? 'justify-center w-10 h-10' : ''}`} title={isCollapsed ? "Requirements" : undefined}>
          <SettingsIcon className="h-4 w-4 shrink-0" />
